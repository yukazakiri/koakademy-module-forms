...
class StoreFormRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'fields.*.presentation.control' => ['nullable', Rule::in(['auto', 'input', 'select', 'radio_cards', 'combobox', 'philippine_location'])],
            ...
            'fields.*.presentation.allow_custom' => ['nullable', 'boolean'],
